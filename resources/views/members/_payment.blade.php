    ...
    <div class="col-md-12">
        <div class="panel no-border">
            <div class="panel-title">
                <div class="panel-head font-size-20">Pago</div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('payment_amount','Pago recibido') !!}
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('payment_amount_pending','Pendiente') !!}
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-inr"></i></div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('mode',array('1' => 'Efectivo', '0' => 'Tarjeta'),1,['class'=>'form-control selectpicker show-tick show-menu-arrow', 'id' => 'mode']) !!}
                        </div>
                    </div>
                </div> 
